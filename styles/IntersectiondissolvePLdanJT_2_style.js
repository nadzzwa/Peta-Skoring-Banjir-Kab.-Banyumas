...
var style_IntersectiondissolvePLdanJT_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("Total Skor");
    ...
    if (value >= 0.000000 && value <= 5.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.000000 && value <= 13.000000) {
            style = [ new ol.style.Style({
